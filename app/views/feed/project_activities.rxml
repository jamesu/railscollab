...
xml.rss "version" => "2.0", "xmlns:dc" => "http://purl.org/dc/elements/1.1/" do
  ...
  xml.channel do 
    xml.title :recent_project_activities_feed.l_with_args(:project => @project.name)
    xml.link @activity_url
    xml.description :recent_project_activities_feed_info.l_with_args(:project => @project.name)    
    xml.language 'en-us'
